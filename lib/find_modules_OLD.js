...
// }
//
// function findModules (found, file, options, isEntry, initialLines) {
...
//             found.requireAs[ext] = p.requireAs;
//         }
//
//     } catch (err) {
...
//
//     found.modules[filepath] = {
//         id: Object.keys(found.modules).length,
//         path: filepath,
//         contents: contents,
//         sourcemap: {
//             source: filepath,
...
//                 };
//
//                 Object.assign(found.modules, findModules(found, subfile, options).modules);
//             }
//
//             relMap[req] = mod.path;
//
...
//     });
//
//     found.modules[filepath].relMap = relMap;
//
//     return found;
// }
//
