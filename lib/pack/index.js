...
function packModules(store, mapDependency, cumulativeLines, options) {
    ...
    // pull entry to top, override id=0
    var entryFilePath = Object.keys(modules).pop();
    var entryMod = modules[entryFilePath];
    entryMod.id = 0;
